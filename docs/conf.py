...
project = 'msl-nlf'
copyright = nlf.__copyright__[1:]
author = nlf.__author__
...
version = nlf.__version__
# The full version, including alpha/beta/rc tags.
release = nlf.__version__
...
latex_documents = [
    (master_doc, 'msl-nlf.tex', 'msl-nlf Documentation',
...
man_pages = [
    (master_doc, 'msl-nlf', 'msl-nlf Documentation',
     [author], 1)
]
...
intersphinx_mapping = {
    'GTC': ('https://gtc.readthedocs.io/en/stable/', None),
